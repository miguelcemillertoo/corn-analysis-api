...
pest_disease_nutrient_classifier_id = '1uiTYQ19yZCFl00du8vvwNGnkY9lyQP6G'
pest_disease_nutrient_classifier_path = r'./static/hdf5/pest-disease-nutrient-classifier.hdf5'

pest_classifier_id = '1CXTIbuuCWEdH0WHg5_1fI817EZWl_g0b'
pest_classifier_path = r'./static/hdf5/pest-classifier.hdf5'

disease_classifier_id = '1ogkcK4V6Ia48nnOVOmtspGtouQavE6rC'
disease_classifier_path = r'./static/hdf5/disease-classifier.hdf5'

def download_models():
    # pest-disease-nutrient.hdf5
    if not os.path.exists(pest_disease_nutrient_classifier_path):
        # download 
        download_file_from_google_drive(pest_disease_nutrient_classifier_id, pest_disease_nutrient_classifier_path)
    else: 
        print("pest-disease-nutrient-classifier.hdf5 already exists")

    # pest-classifier.hdf5
    if not os.path.exists(pest_classifier_path):
        # download 
        download_file_from_google_drive(pest_classifier_id, pest_classifier_path)
    else: 
        print("pest-classifier.hdf5 already exists")

    # disease-classifier.hdf5
    if not os.path.exists(disease_classifier_path):
        # download 
        download_file_from_google_drive(disease_classifier_id, disease_classifier_path)
    else: 
        print("disease-classifier.hdf5 already exists")
